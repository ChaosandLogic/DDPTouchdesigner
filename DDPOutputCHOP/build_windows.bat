...
if errorlevel 1 (
    ...
    echo DLL location: build\Release\DDPOutputCHOP.dll
...
echo %USERPROFILE%\Documents\Derivative\Plugins\DDPOutputCHOP.dll
echo.
echo Next steps:
echo 1. Restart TouchDesigner
echo 2. Look for "DDP Out" in the Custom tab
echo.
pause
